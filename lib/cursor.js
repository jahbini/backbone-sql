  ...
  module.exports = SqlCursor = (function(superClass) {
    ...
    SqlCursor.prototype.queryToJSON = function(callback) {
      ...
      if (this._cursor.$values) {
        $fields = this._cursor.$whitelist ? _.intersection(this._cursor.$values, this._cursor.$whitelist) : this._cursor.$values;
      } else if (this._cursor.$select) {
        $fields = this._cursor.$whitelist ? _.intersection(this._cursor.$select, this._cursor.$whitelist) : this._cursor.$select;
      } else if (this._cursor.$whitelist) {
        $fields = this._cursor.$whitelist;
      }
